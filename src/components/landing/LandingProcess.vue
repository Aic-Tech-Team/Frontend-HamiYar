...
const steps = [
  {
    ...
    title: "بررسی اطلاعات دانشجو",
    description: "درخواست ارسال‌شده توسط دانشجو بررسی و اطلاعات موردنیاز تأیید می‌شود.",
  ...
  },
  {
    ...
    title: "ثبت اطلاعات",
    description: "اطلاعات دانشجو در سامانه وارد شده و نوع نامه موردنظر انتخاب می‌شود.",
  ...
  },
  {
    ...
    title: "ارسال برای دانشجو",
    description: "فایل نهایی برای دانشجو ارسال شده یا جهت چاپ در اختیار واحد مربوطه قرار می‌گیرد.",
